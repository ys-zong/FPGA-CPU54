...
set rc [catch {
  ...
  set_property ip_repo_paths d:/Mathlogic/Project/cpu54/cpu.cache/ip [current_project]
  set_property ip_output_repo d:/Mathlogic/Project/cpu54/cpu.cache/ip [current_project]
  add_files -quiet D:/Mathlogic/Project/cpu54/cpu.runs/synth_1/sccomp_dataflow.dcp
  add_files -quiet d:/Mathlogic/Project/cpu54/cpu.srcs/sources_1/ip/imem_f/imem_f.dcp
  set_property netlist_only true [get_files d:/Mathlogic/Project/cpu54/cpu.srcs/sources_1/ip/imem_f/imem_f.dcp]
  read_xdc -mode out_of_context -ref imem_f -cells U0 d:/Mathlogic/Project/cpu54/cpu.srcs/sources_1/ip/imem_f/imem_f_ooc.xdc
  set_property processing_order EARLY [get_files d:/Mathlogic/Project/cpu54/cpu.srcs/sources_1/ip/imem_f/imem_f_ooc.xdc]
